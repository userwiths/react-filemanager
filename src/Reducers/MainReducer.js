...
const MainReducer = (state = defaultState, action) => {
  let edditSettings = updated => {
    let object = state.user_settings;
    object[Object.keys(updated)[0]] = object[Object.values(updated)[0]];
    return object;
  };
  switch (action.type) {
    case "SET_PATH":
    ...
    case "SET_FILE_LIST_SUB_LIST":
      return Object.assign({}, state, {
        fileListSublist: action.value.sort((a, b) =>
          a.type < b.type ? -1 : a.name.toLowerCase() > b.name.toLowerCase()
        )
      });
    ...
    case "SET_VISIBLE_DIALOG_CONTENT_IMAGE":
      return Object.assign({}, state, {
        visibleDialogContentImage: !!action.value
      });

    case "SET_VISIBLE_DIALOG_CONTENT_VIDEO":
      return Object.assign({}, state, {
        visibleDialogContentVideo: !!action.value
      });
    ...
    case "SET_CURRENT_PAGE":
      return Object.assign({}, state, {
        user_settings: {
          ...
          itemsPerPage: state.user_settings.itemsPerPage,
          usePaging: state.user_settings.usePaging
        }
      });
    ...
    case "SET_FILE_CONTENT":
      ...
      return Object.assign({}, state, {
        fileContentBlobUrl: action.value
          ? URL.createObjectURL(action.value)
          : null
      });
